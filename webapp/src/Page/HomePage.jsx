    ...
    <div className="font-poppins">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center mt-20 border-b pb-4">
          ...
          <div className="flex space-x-4 flex-shrink-0">
            ...
            <a
              href="/ProjectPosting"
              className="text-[16px] text-white bg-black rounded border-[2px] border-black py-4 px-4 transition-colors hover:bg-gray-500"
            >
              Post Project
            </a>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 mb-20">
        <div className="flex justify-between items-center mt-20 pb-4">
          <div className="text-[30px] font-bold">Explore endless professional possibilities</div>
        </div>
          ...
          {jobCategories.map((category) => (
            ...
            >
              <div className="flex flex-col items-center space-x-3">
                {category.icon && (
                  <img src={category.icon || "/placeholder.svg"} alt={`${category.name} icon`} className="w-8 h-8" />
                )}
